...
c: Student = {"name": 1, "age": 15, "school": "Hogwarts"}  # expect-type-error
d: Student = {(1,): "Tom", "age": 2, "school": "Hogwarts"}  # expect-type-error
e: Student = {"name": "Tom", "age": "2", "school": "Hogwarts"}  # expect-type-error
f: Student = {"z": "Tom", "age": 2}  # expect-type-error
